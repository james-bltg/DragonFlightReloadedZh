...
DFRL:NewMod("Gui-info", 5, function()
    ...
    function Setup:Performance()
        ...
        for i = 1, table.getn(gui) do
            ...
            self.perfTexts[idx]:SetText(DFRL:TrText(entry.name))
    ...
    function Setup:ActiveScripts()
        ...
        for i = 1, table.getn(gui) do
            ...
            scriptText:SetText(DFRL:TrText(scriptName))
            scriptText:SetTextColor(1, 1, 1)

            statusText:SetText(DFRL.activeScripts[scriptName] and DFRL:TrText("ON") or DFRL:TrText("OFF"))
