...
DFRL:NewMod("GUI-Dragonflight", 4, function()
    ...
    function Setup:MinMaxClose()
        ...
        _G.SlashCmdList["DFRL"] = function(msg)
            ...
            if msg == "move" then
                if DFRL.ToggleMovableMode then
                    DFRL:ToggleMovableMode()
                else
                    print(DFRL:TrText("|cffffd200Dragonflight:|r Mode movable non disponible"))
                end
            elseif msg == "lang" or msg == "cn" or msg == "zh" then
    ...
    function Setup:GameMenuButton()
        if not self.gamemenuBtn then
            ...
            self.gamemenuBtn:SetText(DFRL:TrText("|cFFFFD100Dragonflight:|r Reloaded"))
