...
DFRL:NewMod("Map", 1, function()
    ...
    f:SetScript("OnEvent", function()
        -- setup
        local Setup = {
            texpath = DFRL:GetInfoOrCons("tex") .. "minimap\\",
            ...
            function PWBInit(color)
                ...
                HookAddonOrVariable("PizzaWorldBuffs", function()
                    local CONTROL = {
                        ...
                        custom_text  = color and DFRL:TrText("|cffff9999Horde")    or DFRL:TrText("|cffddddddHorde"),
                        custom_text2 = color and DFRL:TrText("|cff99ccffAlliance") or DFRL:TrText("|cffddddddAlliance"),
                        custom_text3 = "",
                    ...
                    local function getCustomText()
                        if currentColorMode then
                            return DFRL:TrText("|cffff9999Horde"), DFRL:TrText("|cff99ccffAlliance")
                        else
                            return DFRL:TrText("|cffddddddHorde"), DFRL:TrText("|cffddddddAlliance")
                        end
                    end
