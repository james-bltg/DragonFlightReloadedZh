...
DFRL:NewMod("Talents", 1, function()
    ...
    local function CreateMainFrame()
        ...
        leftHeader:SetTexture(DFRL:GetInfoOrCons('tex') .. 'ui\\top_ui_header_left.tga')
        ...
        rightHeader:SetTexture(DFRL:GetInfoOrCons('tex') .. 'ui\\top_ui_header_right.tga')
        ...
        for i = 1, 5 do
            ...
            middleHeader:SetTexture(DFRL:GetInfoOrCons('tex') .. 'ui\\top_ui_header.tga')
        ...
        closeButton:SetNormalTexture(DFRL:GetInfoOrCons('tex') .. 'ui\\close_normal.tga')
        closeButton:SetPushedTexture(DFRL:GetInfoOrCons('tex') .. 'ui\\close_pushed.tga')
        closeButton:SetHighlightTexture(DFRL:GetInfoOrCons('tex') .. 'ui\\close_normal.tga')
