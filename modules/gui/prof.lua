...
DFRL:NewMod("Gui-prof", 4, function()
    ...
    function Setup:ListFrame()
        ...
        self.ui.curText:SetText(DFRL:TrText("Current:") .. "   |cff80ff80" .. curProf .. "|r")
        ...
        for _, name in ipairs(sortedProfiles) do
            ...
            if name ~= "Default" then
                ...
                switchBtn:SetScript("OnClick", function()
                    ...
                    Setup.ui.warner:SetText(string.format(DFRL:TrText("switched to %s"), clickedName))
                ...
                copyBtn:SetScript("OnClick", function()
                    ...
                    Setup.ui.warner:SetText(string.format(DFRL:TrText("profile copied from %s"), clickedName))
                    Setup.ui.warner:Show()
                    Setup:RestartWarnerPulse()
                end)
                ...
                delBtn:SetScript("OnClick", function()
                    ...
                    Setup.ui.warner:SetText(string.format(DFRL:TrText("%s deleted"), clickedName))
                    Setup.ui.warner:Show()
                    Setup:RestartWarnerPulse()
                end)
