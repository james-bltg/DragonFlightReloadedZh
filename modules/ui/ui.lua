...
DFRL:NewMod("Ui", 5, function()
    ...
    do
        ...
        local path = DFRL:GetInfoOrCons("tex") .. "ui\\close_normal.tga"
        local pathpushed = DFRL:GetInfoOrCons("tex") .. "ui\\close_pushed.tga"
                ...
                if region:GetObjectType() == "Texture" then
                    ...
                    if texture then
                        if texture == "Interface\\QuestFrame\\UI-QuestLog-Left" then
                            region:SetTexture(DFRL:GetInfoOrCons("tex") .. "ui\\questlog_left.tga")
                        elseif texture == "Interface\\QuestFrame\\UI-QuestLog-Right" then
                            region:SetTexture(DFRL:GetInfoOrCons("tex") .. "ui\\questlog_right.tga")
                        end
                    end
                end
            end
    ...
    do
        local tex = {
            DFRL:GetInfoOrCons("tex") .. "ui\\paperdoll_top_left.tga",
            DFRL:GetInfoOrCons("tex") .. "ui\\paperdoll_top_right.tga",
            DFRL:GetInfoOrCons("tex") .. "ui\\paperdoll_bot_left.tga",
            DFRL:GetInfoOrCons("tex") .. "ui\\paperdoll_bot_right.tga",
        }
    ...
    do
        local function ApplyCustomTextures(frame)
            ...
            if not frame.customTopLeft then
                ...
                frame.customTopLeft:SetTexture(DFRL:GetInfoOrCons("tex") .. "ui\\paperdoll_top_left.tga")
                ...
                frame.customTopRight:SetTexture(DFRL:GetInfoOrCons("tex") .. "ui\\paperdoll_top_right.tga")
                ...
                frame.customBottomLeft:SetTexture(DFRL:GetInfoOrCons("tex") .. "ui\\paperdoll_bot_left.tga")
                ...
                frame.customBottomRight:SetTexture(DFRL:GetInfoOrCons("tex") .. "ui\\paperdoll_bot_right.tga")
            ...
            if not frame.customTopLeft then
                ...
                for i = 1, 12 do
                    ...
                    if button then
                        ...
                        if bg then
                            bg:SetTexture(DFRL:GetInfoOrCons("tex") .. "ui\\spell_bg.tga")
                            bg:SetWidth(44)
                            bg:SetHeight(44)
                        end
