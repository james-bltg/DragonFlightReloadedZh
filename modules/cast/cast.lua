...
DFRL:NewMod("Cast", 1, function()
    ...
    local Setup = {
        ...
        config = {
            width            = 200,
            height           = 16,
            bgTexture        = DFRL:GetInfoOrCons("tex") .. "castbar\\CastingBarBackground.blp",
            barTexture       = DFRL:GetInfoOrCons("tex") .. "castbar\\CastingBarStandard3.blp",
            dropshadow       = DFRL:GetInfoOrCons("tex") .. "castbar\\CastingBarFrameDropShadow.blp",
            flashTex         = DFRL:GetInfoOrCons("tex") .. "castbar\\CastingBarFrameFlash.tga",
            borderframe      = DFRL:GetInfoOrCons("tex") .. "castbar\\CastingBarFrame.blp",
